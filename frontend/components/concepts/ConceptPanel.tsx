...
export function ConceptPanel() {
  ...
  return (
    <aside
      ...
      className="sg-enter absolute right-0 top-0 z-20 flex h-full w-[330px] flex-col overflow-y-auto border-l border-line bg-surface shadow-2xl shadow-black/60"
    >
      <header className="sticky top-0 z-10 border-b border-line bg-surface px-4 py-3.5">
        <div className="flex items-start gap-2">
          <h2 className="flex-1 text-[15px] font-semibold leading-tight tracking-tight text-ink">
            {concept.name}
          </h2>
          <button
            type="button"
