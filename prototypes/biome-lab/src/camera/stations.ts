...
export const STATIONS: Record<StationId, Station> = {
  arrival: { id: 'arrival', label: 'Arrival', pitchDeg: 30, azimuthDeg: 22, fov: 26, fitWidth: 0.7, targetLift: 4 },
  overview: { id: 'overview', label: 'Overview', pitchDeg: 36, azimuthDeg: 35, fov: 26, fitWidth: 0.7, targetLift: 3 },
