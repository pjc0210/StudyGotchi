  ...
  return (
    <group>
      {Array.from({ length: residents }, (_, i) => {
        ...
        return (
          <group key={i} position={[d.center[0] + Math.cos(a) * 7, 0, d.center[1] + Math.sin(a) * 6]} scale={L.creatureScale}>
            <mesh position={[0, 0.65, 0]} castShadow><dodecahedronGeometry args={[0.52, 0]} /><Surf color={i % 2 ? P.canvas : P.teal} /></mesh>
            <mesh position={[0, 1.32, 0]} castShadow><icosahedronGeometry args={[0.38, 1]} /><Surf color={P.canvas} /></mesh>
            <mesh position={[0, 1.7, 0]} castShadow><cylinderGeometry args={[0.52, 0.42, 0.25, 10]} /><Surf color={i % 3 ? P.oxblood : P.mustard} /></mesh>
            <mesh position={[0, 1.93, 0]} castShadow><cylinderGeometry args={[0.31, 0.38, 0.5, 8]} /><Surf color={i % 3 ? P.oxblood : P.mustard} /></mesh>
